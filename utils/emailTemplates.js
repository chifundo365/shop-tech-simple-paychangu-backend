    ...
    (p) => `
      <tr style="border-bottom: 1px solid #E5E7EB;">
        ...
        <td style="padding: 16px 0; text-align: right; vertical-align: top;">
          <div style="font-weight: 600; color: #111827;">MWK ${(p.price * p.quantity).toLocaleString()}</div>
          <div style="font-size: 14px; color: #6B7280;">MWK ${p.price.toLocaleString()} each</div>
        </td>
      </tr>
    `
  ).join("");
            ...
            <div style="background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 12px; padding: 24px; margin-bottom: 32px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                <tr>
                  ...
                  <td style="padding: 8px 0; text-align: right; color: #111827; font-size: 18px; font-weight: 700;">MWK ${amount.toLocaleString()}</td>
                </tr>
                ${paymentData.charges ? `
                <tr>
                  <td style="padding: 8px 0; color: #6B7280; font-size: 14px;">Transaction Fee</td>
                  <td style="padding: 8px 0; text-align: right; color: #6B7280; font-size: 14px;">MWK ${paymentData.charges.toLocaleString()}</td>
                </tr>
                ` : ''}
                <tr>
                ...
                <div style="background: #F9FAFB; padding: 16px 20px; border-top: 1px solid #E5E7EB;">
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td style="text-align: right; color: #374151; font-size: 14px; font-weight: 500;">MWK ${totalAmount.toLocaleString()}</td>
                    </tr>
                    ${paymentData.charges ? `
                    <tr>
                      <td style="color: #6B7280; font-size: 14px; padding-top: 8px;">Fees</td>
                      <td style="text-align: right; color: #374151; font-size: 14px; padding-top: 8px;">MWK ${paymentData.charges.toLocaleString()}</td>
                    </tr>
                    ` : ''}
                    <tr style="border-top: 1px solid #E5E7EB;">
                      <td style="color: #111827; font-size: 16px; font-weight: 700; padding-top: 12px;">Total</td>
                      <td style="text-align: right; color: #111827; font-size: 16px; font-weight: 700; padding-top: 12px;">MWK ${amount.toLocaleString()}</td>
                    </tr>
                  </table>
                </div>
                ` : ''}
